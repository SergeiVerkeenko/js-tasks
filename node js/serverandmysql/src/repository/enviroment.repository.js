...
async function getEnviromentIdDB(id) {
    const client = await pool.connect()
...
async function updataEnviromentDB(id, label, category, priority) {
    const client = await pool.connect()
...
module.exports = { createEnviromentDB, getEnviromentDB, getEnviromentIdDB, updataEnviromentDB }